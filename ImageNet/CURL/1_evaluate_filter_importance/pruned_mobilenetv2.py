...
if __name__ == '__main__':
    channel_number = [16, 24, 96, 141, 32, 144, 163, 158, 64, 191, 159, 129,
                      140, 96, 378, 325, 305, 160, 532, 590, 520, 275, 676]
    model = MobileNetV2(num_classes=1000, channel_number=channel_number)
