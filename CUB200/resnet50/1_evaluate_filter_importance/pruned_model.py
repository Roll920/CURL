...
class ResNet(nn.Module):
    ...
    def __init__(self, channel_index, block, layers, num_classes=1000, zero_init_residual=False,
...
def resnet50(channel_index, **kwargs):
    ...
    """
    layers = [3, 4, 6, 3]
    model = ResNet(channel_index, Bottleneck, layers, **kwargs)
    return model


if __name__ == '__main__':
    channel_index = [229, 45, 43, 33, 33, 32, 64, 452, 105, 120, 38, 51, 38, 70, 38, 78, 706, 242, 191, 76, 76, 76, 76,
                     76, 76, 76, 76, 76, 76, 614, 307, 175, 153, 153, 216, 153]
    model = resnet50(channel_index, num_classes=1000).cuda()
