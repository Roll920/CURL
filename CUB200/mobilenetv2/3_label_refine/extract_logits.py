...
from ori_mobilenetv2 import MobileNetV2
...
def extract_logits():
    ...
    model = MobileNetV2(num_classes=FLAGS['class_num'])
...
if __name__ == '__main__':
    ...
    # a = data_list[0:1*5994]
    # b = data_list[1*5994:2*5994]
    # data_list = np.append(a, b)
    # data_list = a
    # np.save('data_list.npy', data_list)
    extract_logits()
